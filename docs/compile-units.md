...
|---|---|---|---|
| `0x401ac0–0x4042b0` | 69 | **GameData** — reads `YodaDemo.dta` | `GameData`, `Nevada`, `Alaska`, `Oregon` |
...
| `0x405ae0–0x4070e0` | **Zone runtime + IACT scripts** — `Zone_ReadData`/`ReadZaux`/`ReadZax2-4`, `Iact_Run` |
