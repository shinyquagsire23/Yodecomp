...
| `MapZone` | **0x34** | TRACED — grid stride at `World+0x4b4` (100 records) | overview-grid cell (10×10 galaxy). `exists@0` (0xffff=empty), **7 shorts @0x8–0x14** (all 0xffff-init by `Worldgen_SetupGrid`, filled by `Worldgen_PlaceZone` — semantics TBD, likely zone-id/links/quest slots), `flagSolved@0x18`, `flagA/B@0x20/24`, ints@0x1c/0x28, short@0x2c. No DA equiv (engine-specific) |
...
| `World` | **0x33c0** | TRACED — `CDeskcppDoc` `CRuntimeClass.m_nObjectSize` @0x44c2b0 | the CDocument game doc (real MFC name `CDeskcppDoc`). `tileArray@0x84`(Tile**), `zoneObjects@0x98`(Zone**), `characters@0xc0`, `currentZone@0x2c0`, `playerX/Y@0x2e20/24`, `cameraX/Y@0x3330/34`, `invArray@0xa8`(CObArray: `inventory`m_pData@0xac/`inventoryCount`m_nSize@0xb0), `currentWeapon@0x2e2c`, `nWeaponBox{Left,Top,Right,Bottom}@0x32a4/a8/ac/b0` (weapon-box screen rect), health/score/experience (see game-logic.md) |
