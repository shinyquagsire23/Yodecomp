...
|---|---|---|---|
| `Zone` | **0x848** | TRACED — `operator_new(0x848)` in `Dta_ReadZone` (0x426acf) → `Zone_Ctor` | 18×18 map. `flags@4`/`areaType@6`/`typeByte3@7` (a 4-byte zone-type dword), `activatedFlag@8` (0 until World::PlaceZoneObjectsMaybe stamps its objects into the grid on first entry), `width@0xc`/`height@0xe`, `tiles[972]@0x10`. **7 embedded CObArrays** (vtable@base/m_pData@+4/m_nSize@+8): `objects@0x7a8`(ZoneObj**@0x7ac), `iactScripts@0x7bc`, `entities@0x7d0`, `cobArray4@0x7e4`, `cobArray5@0x7f8`, `genCandidateA@0x80c`+`genCandidateB@0x820` (worldgen candidate-spot scratch). `tempVar@0x834`/`randVar@0x838`/`globalVar@0x844`, `zoneUnk846@0x846`. **Module match-ready (2026-07-05)** |
