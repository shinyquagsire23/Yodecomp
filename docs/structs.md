...
| `Character` | **0x4c** | TRACED — `operator_new(0x4c)` in `Dta_ParseChar` (0x421e70) → `Character::Read` (0x4047a0) → `World.characters@0xc0` (`Character**`) | **IN-MEMORY layout (disasm-pinned 2026-07-05 from Ctor 0x404670 / InitMaybe 0x404750 / GetFrameTile 0x404850): `vftable@0` (0x44b160), `short frames[24]@0x4` (3 banks × 8 facing-dirs, -1=none; row idx: dx=1→dy+6, dx=-1→dy+3, dx=0→(dy!=-1); bank offsets 0/8/16 shorts; fallback frame = frames[1] = down), `unk34@0x34` (short, Read arg a), `moveType@0x36` (`CharMoveType` — GameView::Tick AI switch), `unk38@0x38` (short, init -1), `unk3a@0x3a` (short, init 1), `currentFrame@0x3c` (short, cached by GetFrameTile), `damage@0x3e` (short, default 1; AddHealth(-damage)), `unk40@0x40` (short, Read arg c), `unk44@0x44` (int, Read arg d), `unk48@0x48` (short, ctor 0).** The old `name[0x10]@8`/`flags@0x18`/`framesA@0x1c` layout was the FILE format (DA `ichr_data`) — the name is read to stack and NOT stored in-memory; do not use file offsets for in-memory reads. |
